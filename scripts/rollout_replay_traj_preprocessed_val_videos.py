...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_chunk', type=int, default=None)
    parser.add_argument('--val_chunk_id', type=int, default=None)
    ...
    for val_id_i, text_i, start_idx_i in zip(val_ids, instruction, start_idx_list):
        if val_id_i == '0':
            continue
