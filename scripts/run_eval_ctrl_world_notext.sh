...
MAX_TRAJS=256
START_IDX=8
OUTPUT_DIR=$SCRATCH/SAILOR/Evals/DROID/ctrl_world_256_start8_notext

cd /home/mila/a/arnav-kumar.jain/LLM/Ctrl-World

echo "=== Ctrl-World Eval (no text): chunk ${SLURM_ARRAY_TASK_ID}/${NUM_CHUNKS}, max_trajs=${MAX_TRAJS}, start_idx=${START_IDX} ==="
